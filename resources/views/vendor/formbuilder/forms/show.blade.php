                    ...
                    <h5 class="card-title">
                        ...
                        <div class="btn-toolbar float-md-right" role="toolbar">
                            <div class="btn-group" role="group">
                                <a href="{{ route('formbuilder::forms.submissions.index', Crypt::encrypt($form->id)) }}" class="btn btn-primary float-md-right btn-sm">
                                    <i class="fa fa-th-list"></i> Submissions
                                </a>
                                <a href="{{ route('formbuilder::forms.edit', Crypt::encrypt($form->id)) }}" class="btn btn-primary float-md-right btn-sm">
