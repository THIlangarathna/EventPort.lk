		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<div class="login100-pic js-tilt" data-tilt>
					...
					<img src="create_event/images/img-01.svg" alt="IMG">
				</div>
				 
				<form class="login100-form validate-form" method="POST" action = "/submit" enctype="multipart/form-data">
					@csrf
					<span class="login100-form-title1">
						<h3> Create an Event</h3>
					</span>
					<div class="wrap-input100 " >
					  <input class="input100" type="text" name="eventname" placeholder="Event name" required>
					...
					<div class="wrap-input100 " >
						<textarea id="description" type="textarea" class="input100" rows="5" name="description" placeholder="Description" required style="padding-left:80px;"></textarea>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
					...
					<div class="wrap-input100 ">
					  <input class="input100" type="text" name="venue" placeholder="Venue" required>
					  <span class="focus-input100"></span>
					  <span class="symbol-input100">
					...
					<div class="wrap-input100 " >
					  <input class="input100" type="time" name="starttime" placeholder="Start Time" required>
					  <span class="focus-input100"></span>
					  <span class="symbol-input100">
					...
					<div class="wrap-input100 " >
					  <input class="input100" type="time" name="endtime" placeholder="End Time" required>
					  <span class="focus-input100"></span>
					  <span class="symbol-input100">
						<i class="fa fa-clock-o" aria-hidden="true"></i>
					  </span>
					...
					<div class="wrap-input100 " >
					  <input class="input100" id="upload" type="file" name="cover" placeholder="" required>
					  <span class="focus-input100"></span>
					  <span class="symbol-input100">
